"""
LH Nautical - Question 6 Thorough Analysis
...
# Filter product "Bússola de Bordo 702" (IDs 74 and 240)
...
# Complete calendar from 2020-01 to 2026-12
...
# Calculate 3-month moving average baseline
df_monthly['ma3'] = df_monthly['quantity'].shift(1).rolling(3).mean()

# Train period (up to 2025-12)
train = df_monthly[df_monthly['year_month'] <= '2025-12']

# Test period (Q1 2026: 2026-01, 2026-02, 2026-03)
